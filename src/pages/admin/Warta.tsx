...
const Warta: React.FC = () => {
  ...
  const filteredData = wartaList.filter(
    (item) =>
    ...
    <div className="space-y-10">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-1">
          <h1 className="text-4xl font-bold text-gmmi-navy tracking-tight">
            Warta Jemaat
          </h1>
          <p className="text-gray-500 font-medium">
            Kelola warta dan informasi berkala untuk jemaat.
          </p>
        </div>
        <Button
      ...
      <Card className="rounded-[2rem] border border-gray-100 shadow-sm">
        <CardBody className="p-6">
          <Input
            ...
            classNames={{
              inputWrapper:
                "bg-gray-50/50 group-data-[focused=true]:bg-white group-data-[focused=true]:!border-gmmi-navy h-14 px-6 border-transparent",
            }}
          />
        </CardBody>
      </Card>
      ...
      <Card className="rounded-[3rem] border border-gray-100 shadow-sm overflow-hidden">
        <CardBody className="p-0">
          <Table
            aria-label="Tabel Warta"
            removeWrapper
            className="bg-transparent"
          >
            <TableHeader>
              <TableColumn className="bg-transparent p-8 text-gray-400 font-bold uppercase text-[10px] tracking-widest border-b border-gray-50">
                JUDUL
              </TableColumn>
              <TableColumn className="bg-transparent p-8 text-gray-400 font-bold uppercase text-[10px] tracking-widest border-b border-gray-50">
                ISI
              </TableColumn>
              <TableColumn className="bg-transparent p-8 text-gray-400 font-bold uppercase text-[10px] tracking-widest border-b border-gray-50 text-center">
                TANGGAL
              </TableColumn>
              <TableColumn className="bg-transparent p-8 text-gray-400 font-bold uppercase text-[10px] tracking-widest border-b border-gray-50 text-right">
                AKSI
              </TableColumn>
            </TableHeader>
            <TableBody
              emptyContent={
                <div className="py-20 italic text-gray-400">
                  Belum ada warta yang dibuat.
                </div>
              }
            >
                    ...
                    <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      <Tooltip content="Preview">
                        <Button
                          ...
                          className="bg-purple-50 text-purple-600 rounded-xl"
                        >
                      ...
                      <Tooltip content="Edit Warta">
                        <Button
                          ...
                          className="bg-blue-50 text-blue-600 rounded-xl"
                        >
        ...
        <ModalContent>
          <ModalHeader className="flex flex-col gap-1">
            <h3 className="text-2xl font-bold text-gmmi-navy">
              {editingItem ? "Edit Warta" : "Buat Warta Baru"}
            </h3>
            <p className="text-sm text-gray-500 font-medium">
              Isi informasi warta jemaat.
            </p>
          </ModalHeader>
          <ModalBody className="gap-6">
            <Input
              ...
              classNames={{
                ...
                inputWrapper:
                  "border-gray-200 focus-within:!border-gmmi-navy rounded-[1.5rem] h-14",
              }}
            />
            ...
            <Textarea
              ...
              classNames={{
                ...
                inputWrapper:
                  "border-gray-200 focus-within:!border-gmmi-navy rounded-[1.5rem]",
              }}
            />

            <div className="space-y-2">
              <label className="font-bold text-gmmi-navy pb-2 block">
                Thumbnail (Opsional)
              </label>
          ...
          <ModalBody>
            {previewItem && (
              <div className="space-y-6">
                ...
                <div>
                  <h2 className="text-3xl font-bold text-gmmi-navy mb-2">
                    {previewItem.judul}
                  </h2>
                  <p className="text-sm text-gray-500 font-medium">
                    {previewItem.tanggal}
