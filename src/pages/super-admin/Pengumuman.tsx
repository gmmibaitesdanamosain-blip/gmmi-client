...
const Pengumuman: React.FC = () => {
  ...
  const handleEdit = (item: IAnnouncement) => {
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gmmi-navy">
            Pengumuman Nasional ({announcements.data.length || 0})
          </h1>
          <p className="text-gray-500">
            Kelola pengumuman untuk seluruh cabang GMMI.{" "}
            {loading ? "Loading..." : ""}
          </p>
        </div>
        <Button
      ...
      <Card className="border border-gray-100 shadow-sm">
        <CardBody>
          ...
          <Table aria-label="Tabel Pengumuman">
            ...
            <TableBody
              emptyContent={"Belum ada pengumuman."}
              isLoading={loading}
            >
              {announcements?.data?.map((item) => (
                <TableRow key={item.id}>
                  ...
                  <TableCell>
                    <div className="font-semibold text-gmmi-navy">
            ...
            <>
              ...
              <ModalBody>
                ...
                >
                  ...
                  <SelectItem key="publish">
                    Publish (Tayangkan Langsung)
                  </SelectItem>
                </Select>
              </ModalBody>
              <ModalFooter>
