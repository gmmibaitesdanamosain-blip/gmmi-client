...
import { getAgenda, createAgenda, updateAgenda, deleteAgenda } from '../../services/superAdmin.service';
import {
    Card,
    CardBody,
    Button,
...
const Agenda: React.FC = () => {
    ...
    const upcomingAgenda = agendaList.filter(j => j.status === 'aktif').sort((a, b) =>
        ...
        <div className="space-y-10">
            <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="space-y-1">
                    <h1 className="text-4xl font-bold text-gmmi-navy tracking-tight">Agenda & Jadwal</h1>
                    <p className="text-gray-500 font-medium">Kelola agenda kegiatan yang akan tampil di Beranda.</p>
                </div>
                <Button
            ...
            <Card className="rounded-[3rem] border border-gray-100 shadow-sm overflow-hidden">
                <CardBody className="p-0">
                    <Table aria-label="Tabel Agenda" removeWrapper className="bg-transparent">
                        <TableHeader>
                        ...
                        <TableBody emptyContent={<div className="py-20 italic text-gray-400">Belum ada agenda yang dibuat.</div>}>
                            {agendaList.map((item) => (
            ...
            >
                <ModalContent>
                    <ModalHeader className="flex flex-col gap-1">
                        <h3 className="text-2xl font-bold text-gmmi-navy">{editingItem ? 'Edit Agenda' : 'Tambah Agenda Baru'}</h3>
