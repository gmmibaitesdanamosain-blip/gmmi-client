...
const CarouselManagement: React.FC = () => {
  ...
  const handleEdit = (item: CarouselSlide) => {
    ...
    const foundOption = CTA_OPTIONS.find(
      (opt) =>
        opt.value !== "custom" && opt.value !== "wa" && opt.value === link,
    );
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gmmi-navy">
            Manajemen Carousel Hero
          </h1>
          <p className="text-gray-500">
            Kelola gambar dan teks yang tampil di bagian atas beranda.
          </p>
        </div>
        <Button
          color="primary"
              ...
              <ModalBody className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Input
                    ...
                    onValueChange={(v) =>
                      setFormData({ ...formData, cta_text: v })
                    }
                  />
                  <Select
                ...
                {linkType === "custom" && (
                  <Input
                    ...
                    onValueChange={(v) =>
                      setFormData({ ...formData, cta_link: v })
                    }
                  />
                )}
